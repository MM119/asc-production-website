                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="grid gap-16 lg:grid-cols-[1.2fr_0.8fr] items-start">
                    <div className="space-y-10">
                        <div className="space-y-6">
                            ...
                            <p className="mt-6 text-slate-200 leading-relaxed text-xl font-light max-w-xl">
                                {t.hero.subtitle}
                            </p>
                        </div>
                        ...
                        {t.hero.stats && (
                            <div className="grid gap-6 sm:grid-cols-3 pt-8 border-t border-white/10">
                                    ...
                                    return (
                                        <div key={stat.label} className="flex items-center gap-4 group">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-lg font-serif text-white">{stat.value}</div>
                                            </div>
                                        </div>
                                    );
                                })}
                            ...
                            {t.hero.highlights.map((item) => {
                                ...
                                return (
                                    <div key={item.label} className="flex gap-4 group">
                                        <div className="h-12 w-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300">
