    ...
    return (
        <article className="group flex gap-6 py-8 border-b border-slate-100 last:border-0 hover:bg-slate-50/50 transition-colors duration-300 px-4 -mx-4 rounded-xl">
            <div className="flex flex-col items-center gap-3 shrink-0">
                <div className="h-12 w-12 rounded-full bg-slate-50 flex items-center justify-center text-slate-700 group-hover:bg-[#D4AF37] group-hover:text-white transition-colors duration-300">
                    <Icon className="h-5 w-5" />
                </div>
                {number && (
                    <span className="text-xs font-serif text-slate-300 group-hover:text-[#D4AF37] transition-colors duration-300">
                        {number}
                    </span>
                )}
            </div>
