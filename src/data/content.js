...
export const i18n = {
    en: {
        ...
        hero: {
            ...
            subtitle:
                "Aureus Sigma Capital (ASC) designs transparent, factor-based portfolios in Vietnam’s equity market, targeting superior risk-adjusted returns through rigorous backtesting and explicit drawdown controls. Through regulated managers such as FIDES, institutional investors can access these systematic strategies within compliant mandates.",
            ctas: [
                { label: "Learn how ASC works with FIDES", to: "/partnerships" },
            ...
            stats: [
                ...
                { label: "Implementation", value: "Via licensed managers (e.g., FIDES)", icon: "shield-check" },
            ],
            highlights: [
                ...
                { label: "Explicit drawdown framework", body: "Long-term growth targets are paired with hedging rules for deep market stress.", icon: "shield" },
            ],
        },
        whatWeDo: {
            ...
            expectations: {
                ...
                goals: [
                    "Deliver higher risk-adjusted returns than a simple “buy-the-index” approach over a full market cycle.",
            ...
            performance: {
                ...
                reportingBody:
                    "Institutional and professional investors can request detailed performance, risk, and attribution packs via licensed managers such as FIDES, subject to product-level terms and governance requirements.",
            },
        },
        solutions: {
        ...
        partnerships: {
            intro:
                "ASC’s strategies are accessed through regulated mandates run by licensed managers such as FIDES. ASC designs the systematic framework; licensed partners handle onboarding, suitability, execution, and regulatory reporting.",
            paragraphs: [
                "FIDES is a licensed investment manager with Korean roots operating in Vietnam. It provides regulated products and bespoke mandates, handles client onboarding and ongoing relationships, and implements portfolios with full regulatory reporting.",
                "Clients contract directly with FIDES or another licensed manager. That entity is responsible for ensuring suitability and compliance for each product or mandate.",
                ...
                "Under the memorandum of understanding between FIDES and ASC, responsibilities are clearly defined: ASC develops and maintains the systematic framework, while FIDES decides how and where to deploy strategies, manages day-to-day portfolios under its licences, and delivers regulated reporting and client service. This separation supports institutional governance standards.",
                "As Vietnam’s markets deepen, FIDES and ASC plan to broaden the range of mandates and products that can incorporate ASC’s framework, while keeping research quality, risk control, and regulatory robustness at the centre.",
                "For investors interested in accessing ASC’s strategies, please contact FIDES or another relevant licensed manager directly, or reach out to ASC for an introduction and more detail on how the framework is applied.",
            ],
            roles: [
                {
                    title: "Investors",
                    bullets: ["Eligible local or cross-border investors", "Access regulated FIDES products"],
                },
                {
                    title: "FIDES",
                    bullets: ["Licensed manager in Vietnam", "Client onboarding and servicing", "Portfolio implementation & reporting"],
                },
                {
        ...
        clientSolutions: {
            title: "Client Solutions",
            intro:
                "ASC’s framework supports mandates run by licensed managers such as FIDES. We help structure solutions around specific objectives rather than leading with products.",
            ...
            items: [
                {
                    category: "News",
                    // PILOT (Dec 2025)
                    title: "FIDES and Aureus Sigma Capital Launch Pilot Research Collaboration",
                    slug: "fides-aureus-sigma-capital-strategic-partnership",
                    summary:
                        "FIDES and ASC have signed a memorandum of understanding so that rules-based Vietnamese equity strategies can be offered via FIDES’ licensed platform.",
                    icon: "handshake",
                    image: "/assets/others/boardroom_highrise_1.png",
                },
                {
                    ...
                    summary:
                        "Vietnam’s equity market exhibits distinct microstructural inefficiencies. We discuss why a systematic, factor-based approach offers superior consistency compared to discretionary trading.",
                    icon: "compass",
        ...
        about: {
            ...
            details: [
                ...
                "ASC does not manage client accounts or distribute products directly. Our strategies are implemented exclusively by licensed investment managers such as FIDES, which handle client onboarding, suitability, execution, and reporting. This separation keeps incentives aligned, lets clients work with regulated counterparties, and enables ASC to focus on research, portfolio design, and risk analytics while investing the firm’s own capital in the same strategies.",
            ],
            bioDetails: [
                {
                    name: "Duc (Huy) Nguyen",
        ...
        contact: {
            ...
            note:
                "For information about specific products, account types, or documentation, please contact FIDES (for example via its official website) or another relevant licensed investment manager in your jurisdiction.",
        },
        legal: {
            body:
                "This website is for information only. It is not an offer to sell, or a solicitation of an offer to buy, any security or investment product. Strategies developed by Aureus Sigma Capital (ASC) may be made available to eligible investors only through licensed investment managers such as FIDES, and only where permitted by law. ASC does not provide investment management services to the general public and does not directly solicit or accept capital from retail investors. Any references to our investment process, risk management, or past results describe our general approach and do not guarantee any particular outcome. Past performance, whether actual or simulated, is not a reliable guide to future results. Investing involves risk, including the possible loss of principal.",
    ...
    vi: {
        ...
        hero: {
            ...
            subtitle:
                "Aureus Sigma Capital (ASC) thiết kế các danh mục minh bạch, dựa trên nhân tố (factor-based) tại thị trường chứng khoán Việt Nam, hướng tới lợi nhuận điều chỉnh rủi ro vượt trội thông qua kiểm thử khắt khe và kiểm soát drawdown cụ thể. Thông qua các đối tác quản lý quỹ được cấp phép như FIDES, nhà đầu tư tổ chức có thể tiếp cận các chiến lược hệ thống này.",
            ctas: [
                { label: "Tìm hiểu hợp tác với FIDES", to: "/partnerships" },
            ...
            stats: [
                ...
                { label: "Triển khai", value: "Qua đối tác được cấp phép (như FIDES)", icon: "shield-check" },
            ],
            highlights: [
        ...
        whatWeDo: {
            ...
            intro:
                "Thị trường chứng khoán Việt Nam biến động nhanh và thường bị chi phối bởi tâm lý. Giá có thể di chuyển mạnh theo tin tức, dòng tiền hoặc kỳ vọng chính sách. Triết lý của chúng tôi là nhà đầu tư sẽ được hưởng lợi tốt hơn từ các chiến lược dựa trên quy tắc (rules-based), thúc đẩy bởi các nhân tố, được xây dựng trên dữ liệu địa phương và nhận thức rõ ràng về drawdown.",
            blocks: [
                {
                ...
                },
                {
                    ...
                    body:
                        "Mỗi công ty được đánh giá qua các đặc tính Chất lượng, Giá trị và Động lượng, cộng với thấu kính ổn định bao gồm biến động thực tế, hành vi drawdown và thanh khoản. Các đầu vào này kết hợp thành một hồ sơ cấu trúc được cập nhật theo lịch trình.",
                    icon: "sliders",
                },
                {
                    title: "Xây dựng danh mục",
                    body:
                        "Tất cả các mã đủ điều kiện cạnh tranh song phẳng. Các hồ sơ mạnh hơn, bền bỉ hơn nhận được phân bổ lớn hơn nhưng có kiểm soát, trong khi các mã yếu hơn hoặc biến động mạnh bị giảm tỷ trọng hoặc loại bỏ. Các ràng buộc bao gồm độ tập trung, phơi nhiễm nhân tố, vòng quay và thanh khoản.",
                    icon: "compass",
                },
                {
        ...
        partnerships: {
            intro:
                "Các chiến lược của ASC được tiếp cận thông qua các ủy thác được quản lý bởi các đối tác được cấp phép như FIDES. ASC thiết kế khung hệ thống; đối tác được cấp phép chịu trách nhiệm tiếp nhận khách hàng, đánh giá sự phù hợp, thực thi giao dịch và báo cáo theo quy định.",
            paragraphs: [
                "FIDES là một công ty quản lý quỹ được cấp phép với nguồn gốc Hàn Quốc hoạt động tại Việt Nam. FIDES cung cấp các sản phẩm được quản lý và các ủy thác riêng biệt, xử lý việc tiếp nhận khách hàng và duy trì quan hệ, đồng thời thực hiện danh mục đầu tư với báo cáo tuân thủ đầy đủ.",
                "Khách hàng ký kết hợp đồng trực tiếp với FIDES hoặc một nhà quản lý được cấp phép khác. Đơn vị đó chịu trách nhiệm đảm bảo sự phù hợp và tuân thủ cho từng sản phẩm hoặc ủy thác.",
                "Aureus Sigma Capital là một công ty định lượng độc lập, tập trung duy nhất vào thị trường cổ phiếu Việt Nam. Chúng tôi thiết kế và duy trì khung đầu tư dựa trên nhân tố, cung cấp cập nhật nghiên cứu, quy tắc xây dựng danh mục và phân tích rủi ro, đồng thời đầu tư vốn của chính mình cùng với các nhà đầu tư tiếp cận chiến lược qua đối tác được cấp phép.",
                "ASC không quản lý tài khoản khách hàng hoặc phân phối sản phẩm. Việc triển khai được thực hiện độc quyền bởi các nhà quản lý được cấp phép.",
                "Theo biên bản ghi nhớ giữa FIDES và ASC, trách nhiệm được phân định rõ ràng: ASC phát triển và duy trì khung hệ thống, trong khi FIDES quyết định cách thức và địa điểm triển khai chiến lược, quản lý danh mục hàng ngày theo giấy phép của mình và cung cấp dịch vụ khách hàng cùng báo cáo theo quy định pháp luật. Sự phân tách này hỗ trợ các tiêu chuẩn quản trị cấp tổ chức.",
                "Khi thị trường Việt Nam phát triển sâu rộng hơn, FIDES và ASC có kế hoạch mở rộng phạm vi các ủy thác và sản phẩm có thể tích hợp khung đầu tư của ASC, đồng thời giữ chất lượng nghiên cứu, kiểm soát rủi ro và sự vững chắc về pháp lý làm trọng tâm.",
                "Đối với nhà đầu tư quan tâm đến việc tiếp cận các chiến lược của ASC, vui lòng liên hệ trực tiếp với FIDES hoặc nhà quản lý đầu tư được cấp phép phù hợp khác, hoặc liên hệ với ASC để được giới thiệu và biết thêm chi tiết về cách khung đầu tư được áp dụng.",
            ],
            roles: [
                {
                    title: "Nhà đầu tư",
                    bullets: ["Nhà đầu tư đủ điều kiện trong hoặc ngoài nước", "Tiếp cận sản phẩm FIDES được quản lý"],
                },
                {
                    title: "FIDES",
                    bullets: ["Nhà quản lý được cấp phép tại Việt Nam", "Tiếp nhận và phục vụ khách hàng", "Triển khai & Báo cáo danh mục"],
                },
                {
                    title: "Aureus Sigma Capital",
            ...
            items: [
                {
                    category: "Tin tức",
                    // PILOT (T12/2025)
                    title: "FIDES và Aureus Sigma Capital hợp tác thí điểm nghiên cứu chiến lược đầu tư",
                    slug: "fides-aureus-sigma-capital-strategic-partnership",
                    summary:
                        "FIDES Việt Nam và ASC đã ký biên bản ghi nhớ hợp tác nghiên cứu chiến lược đầu tư theo quy tắc, bắt đầu với các danh mục thí điểm nội bộ.",
                    icon: "handshake",
                    image: "/assets/others/boardroom_highrise_1.png",
                },
                {
                    ...
                    slug: "why-we-use-rules-instead-of-gut-feeling",
                    summary:
                        "Thị trường cổ phiếu Việt Nam tồn tại những bất cập vi mô đặc thù. Chúng tôi thảo luận lý do tại sao phương pháp dựa trên nhân tố, hệ thống lại mang lại sự nhất quán vượt trội so với giao dịch chủ động.",
                    icon: "compass",
                    image: "/assets/others/quant_office_dark_2.png",
                },
                {
        ...
        about: {
            ...
            details: [
                "Aureus Sigma Capital (ASC) là một công ty đầu tư định lượng độc lập, thuộc sở hữu của nhà sáng lập, chuyên biệt cho cổ phiếu niêm yết tại Việt Nam. Chúng tôi thiết kế và duy trì các chiến lược dựa trên nhân tố, hệ thống, áp dụng các tiêu chuẩn tổ chức toàn cầu vào dữ liệu, giao dịch và quy định tại địa phương.",
                "Vai trò của chúng tôi là xây dựng động cơ đầu tư phía sau các danh mục cổ phiếu Việt Nam. Chúng tôi làm sạch và tổ chức dữ liệu thị trường và doanh nghiệp, mã hóa các hiểu biết về Giá trị, Chất lượng và Động lượng, và thể hiện chúng thành các quy tắc xác định mua gì, mua bao nhiêu và khi nào điều chỉnh. Mọi vị thế trong danh mục đều có thể truy xuất ngược lại khung được văn bản hóa này.",
                "ASC không trực tiếp quản lý tài khoản khách hàng hoặc phân phối sản phẩm. Các chiến lược của chúng tôi được triển khai độc quyền bởi các nhà quản lý đầu tư được cấp phép như FIDES, đơn vị xử lý việc tiếp nhận khách hàng, tính phù hợp, thực thi và báo cáo. Sự phân tách này giữ cho các động lực liên kết, cho phép khách hàng làm việc với các đối tác được quản lý, và cho phép ASC tập trung vào nghiên cứu, thiết kế danh mục và phân tích rủi ro trong khi đầu tư vốn của chính công ty vào cùng các chiến lược.",
            ],
        ...
        team: {
            ...
            cofounderBio:
                "CFA. Dẫn dắt hoạt động thực thi, vận hành và chuyển giao cho khách hàng của ASC. Cựu Trưởng bộ phận Nghiên cứu tại Fujiwara Capital (quỹ phòng hộ vĩ mô toàn cầu) và Trưởng nhóm Nghiên cứu tại Vietbridge Capital. Tốt nghiệp ESCP Europe. Ông chịu trách nhiệm triển khai khung hệ thống vào danh mục thực tế và phối hợp với các đối tác quản lý quỹ.",
        },
        contact: {
            title: "Liên hệ",
            desc:
                "Đối với các yêu cầu từ tổ chức hoặc chuyên nghiệp, hoặc để thảo luận về cách tiếp cận các chiến lược cổ phiếu Việt Nam hệ thống của ASC thông qua các đối tác được cấp phép như FIDES, vui lòng sử dụng biểu mẫu bên dưới.",
            primaryCta: "Gửi yêu cầu",
            note: "Để biết thông tin về các sản phẩm cụ thể, loại tài khoản hoặc tài liệu, vui lòng liên hệ FIDES (ví dụ qua trang web chính thức) hoặc một nhà quản lý đầu tư được cấp phép phù hợp khác tại khu vực của bạn.",
        },
        legal: {
            body:
                "Trang web này chỉ nhằm mục đích cung cấp thông tin. Đây không phải là lời chào bán hay mời gọi chào mua bất kỳ chứng khoán hay sản phẩm đầu tư nào. Các chiến lược được phát triển bởi Aureus Sigma Capital (ASC) chỉ có thể được cung cấp cho các nhà đầu tư đủ điều kiện thông qua các nhà quản lý đầu tư được cấp phép như FIDES, và chỉ ở những nơi luật pháp cho phép. ASC không cung cấp dịch vụ quản lý đầu tư cho công chúng và không trực tiếp mời gọi hoặc nhận vốn từ nhà đầu tư bán lẻ. Mọi tham chiếu đến quy trình đầu tư, quản trị rủi ro hoặc kết quả quá khứ mô tả phương pháp chung của chúng tôi và không đảm bảo bất kỳ kết quả cụ thể nào. Hiệu suất quá khứ, dù là thực tế hay mô phỏng, không phải là chỉ báo tin cậy cho kết quả tương lai. Đầu tư bao gồm rủi ro, bao gồm khả năng mất vốn gốc.",
...
export const INSIGHTS_CONTENT = {
    ...
    "fides-aureus-sigma-capital-strategic-partnership": {
        en: {
            title: "FIDES and Aureus Sigma Capital Launch Pilot Research Collaboration",
            dateLine: "Ho Chi Minh City, Vietnam – December 2025",
